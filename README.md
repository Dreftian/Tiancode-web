...
[![Versión](https://img.shields.io/badge/versión-v1.0.0-00d2ff.svg?style=flat-square)](https://github.com/Dreftian/Tiancode/releases/latest)
...
|---|---|---|---|---|
| 📦 **Instalador de Windows** | `Tiancode.exe` | ~270 MB | x64 (64-bit) | [**Descargar Instalador (.exe)**](https://github.com/Dreftian/Tiancode/releases/latest/download/Tiancode.exe) |
| 💼 **Versión Portable** | `Tiancode-portable.exe` | ~270 MB | x64 (64-bit) | [**Descargar Portable (.exe)**](https://github.com/Dreftian/Tiancode/releases/latest/download/Tiancode-portable.exe) |
