...
[![Versión](https://img.shields.io/badge/versión-v1.0.45-00d2ff.svg?style=flat-square)](https://github.com/Dreftian/Tiancode/releases/latest)
...
<p align="center">
  ...
  <a href="https://tiancode.vercel.app/recursos/novedades.html"><b>Novedades v1.0.45</b></a>
</p>
...
|---|---|---|---|---|
| 📦 **Instalador de Windows** | `Tiancode.exe` | ~379 MB | x64 (64-bit) | [**Descargar Instalador (.exe)**](https://github.com/Dreftian/Tiancode/releases/latest/download/Tiancode.exe) |
| 💼 **Versión Portable** | `Tiancode-portable.exe` | ~379 MB | x64 (64-bit) | [**Descargar Portable (.exe)**](https://github.com/Dreftian/Tiancode/releases/latest/download/Tiancode-portable.exe) |
