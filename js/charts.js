...
export const EVAL_DATA_ES = {
  swe: {
    ...
    unit: '% resuelto',
    bars: [
      { name: 'Tiancode v1.0.42 (Enjambre + OpenClaw & Hermes)', val: '78.6%', pct: 78.6, highlight: true },
...
export const EVAL_DATA_EN = {
  swe: {
    ...
    unit: '% resolved',
    bars: [
      { name: 'Tiancode v1.0.42 (Swarm + OpenClaw & Hermes)', val: '78.6%', pct: 78.6, highlight: true },
