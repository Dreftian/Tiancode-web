...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.46: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.46…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.46 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.46)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.46: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.46.",
  ...
  "docs.s1p": "Tiancode 1.0.46 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.46 soporta Windows 10 y 11.",
  ...
  "news.sub": "Todo lo que trae Tiancode v1.0.46: el botón de mejorar el prompt usa por fin el modelo y el esfuerzo que elegiste, el micrófono deja de descargar 146 MB sin preguntar y GitHub deja de inventarse permisos y contadores. Incluye lo llegado en 1.0.45.",
  "news.v1": "Versión 1.0.46",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades Principales",
  "news.new1": "El botón de mejorar el prompt usa el modelo y el nivel de razonamiento que elegiste: la variante se descartaba en tres sitios a la vez, así que elegir «Max» no cambiaba nada aquí; el modo de menor esfuerzo sólo se aplica ya cuando el modelo lo eligió el servidor.",
  "news.new2": "Si el modelo que nombraste no está disponible, ahora se te dice, con un atajo para elegir otro: antes un catch se tragaba el error y respondía el modelo pequeño de otro proveedor sin avisar.",
  "news.new3": "Cuatro fallos distintos dejan de compartir un único mensaje: credenciales, límite de peticiones, saldo agotado y «no produjo nada» llegan cada uno con su motivo, gracias a un centinela que el backend añade al final del stream.",
  "news.new4": "El micrófono ya transcribía en local, sin conexión y en español; lo que cambia es que pide permiso antes de descargar sus 146 MB —con el tamaño calculado a partir de los bytes reales y el progreso en el botón— en vez de hacerlo solo al abrir una sesión.",
  "news.new5": "Dictar se añade al final de lo que escribiste en vez de reemplazarlo, ya no tira los adjuntos, no congela la app 1–2 segundos, no corta en silencio a los 64 segundos y entiende los 99 idiomas del modelo, no sólo español e inglés.",
  "news.new6": "Las imágenes del chat llegan al modelo (1.0.45): se corrigieron las tres causas, incluido un redimensionador muerto en todas las builds empaquetadas que mandaba las capturas 4K al proveedor a tamaño completo.",
  ...
  "news.imp2": "La cabecera «Vista previa / Código» deja de cortar su pestaña a media palabra: una escalera responsive de cinco pasos, pestañas reducidas a icono cuando no hay sitio y los cuatro emojis de dispositivo convertidos en un menú que recupera unos 100 px.",
  "news.imp3": "El panel de GitHub se centra de verdad, se lee en el tema claro y explica las seis capacidades que da conectar; la insignia de permisos lee ahora la cabecera real del token y los contadores se paginan en vez de presentar los primeros 30 repositorios como el total.",
  "news.imp4": "«Inteligencia» y «Uso de la PC» dejaron de ofrecer controles que no hacían nada (1.0.45): de 14 controles con 4 en funcionamiento a 9 reales, y 11 conmutadores decorativos cambiados por una herramienta de captura de pantalla y otra de portapapeles.",
  "news.imp5": "Voces: de 27 tarjetas a 6, todas femeninas y en español (1.0.45), unos 644 MB menos de descarga por usuario.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "El texto de privacidad del micrófono decía que «tus últimas 20 grabaciones se guardan en este dispositivo»: no se guarda ningún audio, sólo el texto. Corregido en los siete idiomas, junto con el campo del diccionario de dictado, ilegible en el tema claro.",
  "news.fix2": "Una fuga de credenciales real en GitHub: ante un fallo de arranque de git, la línea de comandos completa acababa pintada en el aviso de error, y ahí viaja el token en base64, que es codificación y no cifrado. Se redacta en el único punto por el que pasan todas.",
  "news.fix3": "«UnsupportedContentType» al actualizar con un proyecto abierto (1.0.45): el aviso era el nombre interno del error, reintentar nunca miraba la causa real y nada reconectaba la parte REST.",
  ...
  "dl.sub": "Tiancode 1.0.46 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.46",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.46",
  ...
  "page.description": "Tiancode v1.0.46: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.46…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.46 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.46)",
  ...
  "preview.sub": "This is Tiancode v1.0.46: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.46.",
  ...
  "docs.s1p": "Tiancode 1.0.46 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.46 supports Windows 10 and 11.",
  ...
  "news.sub": "Everything Tiancode v1.0.46 brings: the prompt-improve button finally uses the model and the effort you picked, the microphone stops downloading 146 MB without asking, and GitHub stops making up permissions and counts. Includes what landed in 1.0.45.",
  "news.v1": "Version 1.0.46",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.46",
  "news.new1": "The prompt-improve button uses the model and the reasoning level you picked: the variant was dropped in three places at once, so choosing “Max” changed nothing here; the low-effort mode now only applies when the server chose the model itself.",
  "news.new2": "If the model you named is not available, you are now told, with a shortcut to pick another one: before, a catch swallowed the error and another provider's small model answered without warning.",
  "news.new3": "Four different failures stop sharing a single message: rejected credentials, rate limit, exhausted balance and “produced nothing” each arrive with their reason, thanks to a sentinel the backend adds at the end of the stream.",
  "news.new4": "The microphone already transcribed locally, offline and in Spanish; what changes is that it asks before downloading its 146 MB —with the size computed from the real bytes and the progress shown on the button— instead of doing it on its own when a session opens.",
  "news.new5": "Dictation appends to what you had typed instead of replacing it, no longer drops your attachments, no longer freezes the app for 1–2 seconds, no longer truncates silently at 64 seconds, and understands the model's 99 languages, not just Spanish and English.",
  "news.new6": "Chat images reach the model (1.0.45): all three causes were fixed, including a resizer that was dead in every packaged build and sent 4K screenshots to the provider at full size.",
  "news.impTitle": "Improvements in v1.0.46",
  ...
  "news.imp2": "The “Preview / Code” header stops clipping its tab mid-word: a real five-step responsive ladder, tabs reduced to icons when there is no room, and the four device emoji turned into a menu that wins back about 100 px.",
  "news.imp3": "The GitHub panel is properly centred, readable in the light theme and explains the six things connecting actually gives you; the permissions badge now reads the token's real header and repo counts are paginated instead of presenting the first 30 as the total.",
  "news.imp4": "Intelligence and PC use stopped offering controls that did nothing (1.0.45): from 14 controls with 4 working to 9 real ones, and 11 decorative toggles traded for a screenshot tool and a clipboard tool.",
  "news.imp5": "Voices: from 27 cards to 6, all female and Spanish (1.0.45), about 644 MB less to download per user.",
  "news.fixTitle": "Fixes",
  "news.fix1": "The microphone's privacy line claimed “your last 20 recordings are stored on this device”: no audio is ever stored, only the text. Fixed in all seven languages, along with the dictation dictionary field, unreadable in the light theme.",
  "news.fix2": "A real credential leak in GitHub: on a git start-up failure the full command line ended up painted in the error notice, and the token travels there in base64, which is encoding, not encryption. It is now redacted at the single point they all pass through.",
  "news.fix3": "“UnsupportedContentType” after updating with a project open (1.0.45): the notice was the error's internal name, retry never looked at the real cause and nothing reconnected the REST side.",
  ...
  "dl.sub": "Tiancode 1.0.46 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.46? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.46",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.46",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.46",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.46",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.46",
  "footer.ecosystem": "Ecosistema",
