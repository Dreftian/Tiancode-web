...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.49: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.49…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.49 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.49)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.49: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.49.",
  ...
  "docs.s1p": "Tiancode 1.0.49 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.49 soporta Windows 10 y 11.",
  ...
  "news.sub": "Tiancode v1.0.49 devuelve el asistente de bienvenida tras cada actualización —una sola pantalla de confirmación con tus respuestas anteriores ya marcadas, no un interrogatorio repetido— y le da por fin interfaz a «Uso de la PC»: permiso del navegador de tres valores, sitios permitidos, cookies, interruptor maestro y lista de ejecutables denegados. Más una vista de transcripción Normal / Pensando / Detallado. Incluye lo llegado en 1.0.48.",
  "news.v1": "Versión 1.0.49",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades principales",
  "news.new1": "El asistente de bienvenida vuelve a salir cuando actualizas, no sólo en la primera instalación. Pero no te va a volver a preguntar todo: tras una actualización es una sola pantalla de confirmación con tus respuestas anteriores ya marcadas —leídas de los ajustes reales, no de una copia— y un único botón. En una instalación nueva sigue siendo el asistente completo de dos pasos.",
  "news.new2": "Dos preguntas nuevas, y las dos gratis: mascota de escritorio y leer las respuestas en voz alta. La de voz usa el ajuste que recurre a las voces de Windows cuando no hay modelo descargado, así que no dispara ninguna descarga: habría deshecho justo lo que quitamos en 1.0.45 y 1.0.46.",
  "news.new3": "«Uso de la PC» tiene por fin interfaz — la 1.0.47 añadió la herramienta de ratón y teclado sin ninguna. Y aquí había una trampa que conviene explicar: el valor por defecto del sistema de permisos es «\"*\": \"allow\"», así que hoy el agente puede leer y manejar el navegador integrado en cualquier sitio sin preguntar nunca. Una lista de «sitios permitidos» encima de eso habría mostrado dos entradas mientras en realidad estaban todos permitidos. Ahora hay un control de tres valores, y elegir «preguntar en cada sitio» escribe la regla base de verdad: es un cambio de comportamiento, porque a partir de ahí te preguntará donde antes no lo hacía.",
  "news.new4": "Sitios permitidos: listar, añadir y revocar, con dos honestidades escritas en el propio panel. Los «Siempre» que aceptas dentro de una sesión no se guardan en disco, así que no aparecen en la lista y se pierden al cerrar; y si la regla general está en «permitir», la lista no cambia nada. También eliges dónde se abren los enlaces: en el navegador integrado o en el del sistema.",
  "news.new5": "Cookies del navegador integrado: siempre, o hasta que cierres Tiancode. Sólo dos valores, porque Electron no deja cambiar la partición de un webview una vez ha navegado. Y llega el interruptor maestro del control del ordenador, guardado fuera del archivo de proyecto: «tiancode.json» es un archivo del repositorio que el propio agente puede reescribir con la herramienta de edición, así que un interruptor que viviera ahí sería editable por aquello que restringe. Junto a él, una lista de ejecutables denegados, persistente, aplicada junto al rechazo de gestores de contraseñas que ya existía.",
  "news.new6": "Vista de transcripción Normal / Pensando / Detallado en Ajustes → Apariencia, con anulación por sesión desde el menú de la conversación. Sustituye a los tres interruptores sueltos que había: mantenerlos al lado habría sido peor, porque escriben lo mismo y el último que tocaras dejaría al otro mostrando un valor falso. «Detallado» abre además las tarjetas de herramienta que antes no podía abrir ninguna combinación de los interruptores viejos.",
  ...
  "news.imp2": "Lo que me negué a poner, y por qué: no hay un interruptor único que cubra «servidores de desarrollo + navegación + capturas», porque las herramientas integradas no pasan por el filtro de permisos y nada puede impedir que el agente arranque un dev server. Un interruptor así habría prometido justo lo que no puede cumplir.",
  "news.imp3": "Tampoco hay selector de «navegador preferido» con Chrome: nada aquí controla un navegador externo, y Chrome y Edge rechazan el puerto de depuración sobre el perfil por defecto, así que sólo podría manejar un navegador sin tus sesiones. Ni «mostrar aplicaciones al terminar»: Tiancode nunca oculta una aplicación, porque el proceso auxiliar no tiene ninguna función de manipulación de ventanas, sólo entrada y lectura.",
  "news.imp4": "El portable ya se comportaba como pedías y no hizo falta tocarlo: guarda su estado en una carpeta «data» junto al propio .exe, así que viaja con el pendrive y sale una vez por pendrive. Todo medido a 1025x560: el paso 1 ocupa 311 px de alto contra 528 disponibles, y la pantalla de carga deja 138 px de holgura bajo el emblema.",
  "news.imp5": "El log del servidor se ve mientras arranca, con los secretos censurados (1.0.48): los valores de variables tipo «*_TOKEN», «*_SECRET» y «*_PASSWORD», las cabeceras «Bearer», las URLs con contraseña y los formatos conocidos se enmascaran antes de mostrarlos, así que lo que copias al portapapeles ya va limpio.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "Cuatro ajustes del asistente que no guardaban nada: escribía «tiancode.sound.enabled», «tiancode.autoupdate.enabled», «tiancode-lang» y «tiancode-theme», y ninguna de las cuatro claves se lee en ningún sitio del programa. Fuera.",
  "news.fix2": "Había DOS asistentes de bienvenida vivos, con dos puertas distintas: este diálogo, gated por localStorage, y otro flujo completo en el proceso de escritorio, gated por otra clave. El segundo no se veía nunca porque el primero corre antes y marca su clave — salvo que las dos se desincronizaran. Se elimina con cuidado: hacía dos cosas más en cada arranque que había que conservar, y una de ellas mantenía la pantalla de carga esperando.",
  "news.fix3": "Se borró «browser.tsx» entero: sus tres interruptores estaban fijados en «activado» con un manejador que sólo mostraba un aviso de éxito, no leían ni escribían nada y el archivo ya estaba huérfano. Y las cookies del navegador integrado se limpian al arrancar, no al salir: los manejadores de salida son síncronos y el borrado es asíncrono, así que hacerlo al salir a veces no llegaba a ocurrir.",
  ...
  "dl.sub": "Tiancode 1.0.49 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.49",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.49",
  ...
  "page.description": "Tiancode v1.0.49: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.49…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.49 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.49)",
  ...
  "preview.sub": "This is Tiancode v1.0.49: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.49.",
  ...
  "docs.s1p": "Tiancode 1.0.49 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.49 supports Windows 10 and 11.",
  ...
  "news.sub": "Tiancode v1.0.49 brings the welcome wizard back after every update — one single confirmation screen with your previous answers already ticked, not a repeat interrogation — and finally gives “PC usage” a UI: a three-value browser permission, allowed sites, cookies, a master switch, and a denied-executables list. Plus a Normal / Thinking / Detailed transcript view. Includes what landed in 1.0.48.",
  "news.v1": "Version 1.0.49",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.49",
  "news.new1": "The welcome wizard now appears again when you update, not only on a first install. But it will not ask you everything again: after an update it is a single confirmation screen with your previous answers already ticked —read from the real settings, not from a copy— and one button. On a fresh install it is still the full two-step wizard.",
  "news.new2": "Two new questions, and both of them free: desktop pet and read the replies aloud. The voice one uses the setting that falls back to the Windows voices when no model has been downloaded, so it triggers no download at all: that would have undone exactly what we removed in 1.0.45 and 1.0.46.",
  "news.new3": "“PC usage” finally has a UI — 1.0.47 shipped the mouse-and-keyboard tool with none. And there was a trap here worth explaining: the permission system's default is “\"*\": \"allow\"”, so today the agent can read and drive the integrated browser on any site without ever asking. An “allowed sites” list on top of that would have shown two entries while in fact everything was permitted. There is now a three-value control, and choosing “ask on every site” writes the real baseline rule: that is a genuine behaviour change, because from then on it will ask where it did not before.",
  "news.new4": "Allowed sites: list, add, and revoke, with two honesties written into the panel itself. The “Always” answers you accept inside a session are never saved to disk, so they do not appear in the list and are lost on close; and if the general rule is set to “allow”, the list changes nothing. You also choose where links open: in the integrated browser or in the system one.",
  "news.new5": "Integrated-browser cookies: always, or until you close Tiancode. Two values only, because Electron will not let a webview change partition once it has navigated. And there is now a master switch for computer control, stored outside the project file: “tiancode.json” is a repository file the agent itself can rewrite with its own edit tool, so a switch living there would be editable by the very thing it restricts. Next to it, a persistent denied-executables list, applied alongside the password-manager rejection that already existed.",
  "news.new6": "A Normal / Thinking / Detailed transcript view in Settings → Appearance, with a per-session override from the conversation menu. It replaces the three loose switches that were there: keeping them side by side would have been worse, because they write the same thing and the last one you touched would leave the other showing a false value. “Detailed” also opens the tool cards that no combination of the old switches could open.",
  "news.impTitle": "Improvements in v1.0.49",
  ...
  "news.imp2": "What I refused to build, and why: there is no single switch covering “dev servers + browsing + screenshots”, because the builtin tools do not pass through the permission filter and nothing can stop the agent from starting a dev server. Such a switch would have promised exactly what it cannot deliver.",
  "news.imp3": "Nor is there a “preferred browser” selector with Chrome: nothing here drives an external browser, and Chrome and Edge both refuse the debugging port on the default profile, so it could only ever drive a browser without your sessions. And no “show apps when it finishes”: Tiancode never hides an app, because the helper process has no window-manipulation function at all, only input and reading.",
  "news.imp4": "The portable build already behaved the way you asked and needed no changes: it stores its state in a “data” folder next to the .exe itself, so it travels with the stick and appears once per stick. All measured at 1025x560: step 1 is 311 px tall against 528 available, and the loading screen leaves 138 px of clearance under the emblem.",
  "news.imp5": "The server log is shown while the server starts, with secrets redacted (1.0.48): the values of “*_TOKEN”, “*_SECRET” and “*_PASSWORD” variables, “Bearer” headers, credentialed URLs and known shapes are masked before being displayed, so what you copy to the clipboard is already clean.",
  "news.fixTitle": "Fixes",
  "news.fix1": "Four wizard settings that saved nothing: it wrote “tiancode.sound.enabled”, “tiancode.autoupdate.enabled”, “tiancode-lang” and “tiancode-theme”, and not one of those four keys is read anywhere in the program. Gone.",
  "news.fix2": "There were TWO live welcome flows, behind two different gates: this dialog, gated by localStorage, and another complete flow in the desktop process, gated by a different key. The second one was never seen because the first runs earlier and marks its key — unless the two ever diverged. It is removed carefully: it did two more things on every startup that had to be preserved, and one of them kept the loading screen waiting.",
  "news.fix3": "“browser.tsx” was deleted outright: its three switches were hardcoded to “on” with a handler that only showed a success toast, they neither read nor wrote anything, and the file was already orphaned. And the integrated-browser cookies are cleared at launch, not on quit: the quit handlers are synchronous and the clear is asynchronous, so doing it on quit sometimes never happened.",
  ...
  "dl.sub": "Tiancode 1.0.49 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.49? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.49",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.49",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.49",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.49",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.49",
  "footer.ecosystem": "Ecosistema",
