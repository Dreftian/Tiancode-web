...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.45: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.45…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.45 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.45)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.45: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.45.",
  ...
  "docs.s1p": "Tiancode 1.0.45 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.45 soporta Windows 10 y 11.",
  ...
  "news.sub": "Todo lo que trae Tiancode v1.0.45: las imágenes del chat llegan por fin al modelo, «Inteligencia» y «Uso de la PC» dejan de ofrecer controles que no hacían nada y las voces se reducen a seis en español. Incluye lo llegado en 1.0.44 y 1.0.43.",
  "news.v1": "Versión 1.0.45",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades Principales",
  "news.new1": "Las imágenes del chat llegan al modelo: se corrigen las tres causas —un data URL vacío en lugar del archivo real, un solo adjunto con error que tumbaba el prompt entero y un redimensionador muerto en todas las builds empaquetadas, así que una captura 4K salía al proveedor a tamaño completo.",
  "news.new2": "«Inteligencia» pasa de 14 controles con 4 en funcionamiento a 9 que llegan de verdad al agente: destilador de salida de bash, reparación de tool-calls, cortacircuitos de bucles infinitos, extracción web limpia y creación de skills.",
  "news.new3": "«Uso de la PC» cambia 11 controles decorativos por dos capacidades reales: una herramienta de captura de pantalla y otra de portapapeles, cada una con su permiso y la del portapapeles preguntando siempre.",
  "news.new4": "Voces: de 27 tarjetas a 6, todas femeninas y en español. Fuera las inglesas de Kokoro y las de Fish, que sin clave de API no podían hablar: unos 644 MB menos de descarga por usuario.",
  "news.new5": "Mascotas y Modelos Locales rediseñados, y el panel de Skills —que no cargaba nada porque llamaba a un método del SDK inexistente— vuelve a usar el endpoint real.",
  "news.new6": "El Sandbox enseña la app de escritorio en vez de describirla (1.0.44): un espejo de su ventana real de Windows, emparejada recorriendo el árbol de procesos, con un selector cuando la evidencia es débil.",
  ...
  "news.imp2": "El botón de mejorar el prompt ya no borra los adjuntos ni finge una reescritura del modelo con un diccionario local: se puede cancelar mientras trabaja y el deshacer sobrevive a que sigas escribiendo.",
  "news.imp3": "La base de datos ya no congela la app cinco segundos (1.0.44): con el cerrojo por ruta, dos compilaciones concurrentes pasan de 5,8 s a 52 ms.",
  "news.imp4": "La vista previa deja de compilar el proyecto entero en cada tecla (1.0.44) y el vigilante de archivos usa el watcher nativo, que poda node_modules y la salida de compilación en el sistema operativo.",
  "news.imp5": "El agente ya puede manejar la app del Sandbox (1.0.43) con «preview_inspect» y «preview_interact», y los paneles de Ajustes se adaptan al ancho del panel en vez de al de la ventana.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "«UnsupportedContentType» al actualizar con un proyecto abierto: el aviso era el nombre interno del error, reintentar nunca miraba la causa real y nada reconectaba la parte REST. Las tres cosas van corregidas.",
  "news.fix2": "«Compilando dist…» que no paraba nunca (1.0.43): Windows anuncia el cambio del directorio como «dist» a secas, sin barra, así que cada compilación se re-armaba con su propia salida.",
  "news.fix3": "«.tiancode» aparecía en la raíz del disco (1.0.43): una carpeta sin repositorio resolvía su proyecto a lo alto de C:, y ahí acababan MEMORY.md, los plugins y las skills de proyecto.",
  ...
  "dl.sub": "Tiancode 1.0.45 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.45",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.45",
  ...
  "page.description": "Tiancode v1.0.45: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.45…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.45 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.45)",
  ...
  "preview.sub": "This is Tiancode v1.0.45: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.45.",
  ...
  "docs.s1p": "Tiancode 1.0.45 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.45 supports Windows 10 and 11.",
  ...
  "news.sub": "Everything Tiancode v1.0.45 brings: chat images finally reach the model, Intelligence and PC use stop offering controls that did nothing, and Voices is down to six Spanish voices. Includes what landed in 1.0.44 and 1.0.43.",
  "news.v1": "Version 1.0.45",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.45",
  "news.new1": "Chat images reach the model: all three causes fixed —an empty data URL instead of the real file, a single failing attachment taking down the whole prompt, and a resizer that was dead in every packaged build, so a 4K screenshot went to the provider at full size.",
  "news.new2": "Intelligence goes from 14 controls with 4 working to 9 that actually reach the agent: bash output distiller, tool-call repair, infinite-loop breaker, clean web extraction and skill creation.",
  "news.new3": "PC use trades 11 decorative controls for two real capabilities: a screenshot tool and a clipboard tool, each with its own permission and the clipboard one always asking first.",
  "news.new4": "Voices: from 27 cards to 6, all female and Spanish. The English Kokoro voices and the Fish ones —which could not speak without an API key— are gone: about 644 MB less to download per user.",
  "news.new5": "Pets and Local Models redesigned, and the Skills panel —which loaded nothing because it called a non-existent SDK method— now uses the real endpoint.",
  "news.new6": "The Sandbox shows the desktop app instead of describing it (1.0.44): a mirror of its real Windows window, matched by walking the process tree, with a picker when the evidence is weak.",
  "news.impTitle": "Improvements in v1.0.45",
  ...
  "news.imp2": "The prompt-improve button no longer deletes your attachments nor fakes a model rewrite with a local dictionary: it can be cancelled mid-run and undo survives you typing on.",
  "news.imp3": "The database no longer freezes the app for five seconds (1.0.44): with a per-path lock, two concurrent builds go from 5.8 s to 52 ms.",
  "news.imp4": "The preview stops rebuilding the whole project on every keystroke (1.0.44) and the file watcher uses the native watcher, pruning node_modules and build output in the OS.",
  "news.imp5": "The agent can now drive the Sandbox app (1.0.43) with “preview_inspect” and “preview_interact”, and Settings panels size themselves against the panel width instead of the window's.",
  "news.fixTitle": "Fixes",
  "news.fix1": "“UnsupportedContentType” after updating with a project open: the notice was the error's internal name, retry never looked at the real cause and nothing reconnected the REST side. All three are fixed.",
  "news.fix2": "“Building dist…” that never stopped (1.0.43): Windows announces the directory change as plain “dist”, with no slash, so every build re-armed itself with its own output.",
  "news.fix3": "“.tiancode” showed up at the drive root (1.0.43): a folder with no repository resolved its project to the top of C:, and MEMORY.md, plugins and project skills ended up there.",
  ...
  "dl.sub": "Tiancode 1.0.45 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.45? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.45",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.45",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.45",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.45",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.45",
  "footer.ecosystem": "Ecosistema",
