...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.47: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.47…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.47 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.47)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.47: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.47.",
  ...
  "docs.s1p": "Tiancode 1.0.47 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.47 soporta Windows 10 y 11.",
  ...
  "news.sub": "Tiancode v1.0.47 es, antes que nada, una versión de seguridad: el agente ya no puede leer ni pulsar una página que tú no estás viendo, y las dos tools de vista previa piden permiso nombrando el origen. Encima llegan el uso del navegador y el uso del computador, los dos con permiso explícito. Incluye lo llegado en 1.0.46.",
  "news.v1": "Versión 1.0.47",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Seguridad y novedades principales",
  "news.new1": "El agente podía leer y pulsar una página que tú no estabas viendo: la única comprobación era «¿es http o https?», sin comparar el origen, y la Vista en vivo es un navegador completo con cookies persistentes cuya vista nativa se ocultaba sin cambiar de página. Navegabas a un sitio con tu sesión, arrancabas tu proyecto, y el modelo recibía la URL, el título, 4.000 caracteres de texto visible y todos los elementos interactivos de esa página oculta. Ahora manda el origen esperado y la vista oculta se va a about:blank.",
  "news.new2": "Ninguna de las dos tools de vista previa pedía permiso: leer y pulsar una página viva estaba menos vigilado que «glob». Ahora piden permiso nombrando el origen concreto, así que un «sí» para este proyecto no es un «sí» para la siguiente página que se abra.",
  "news.new3": "Aceptar una captura inofensiva concedía la pantalla completa para siempre: la tool de captura pasaba un patrón comodín, y como el sistema de permisos apunta una regla por patrón, aprobar una captura de ventana escribía una regla que también valía para la pantalla entera.",
  "news.new4": "Un clic del modelo podía abrir tu navegador real en cualquier URL: la navegación sí estaba bloqueada al origen, pero un clic sobre un enlace no, y un enlace con target «_blank» terminaba en shell.openExternal. Ahora se deniega mientras hay una acción del agente en curso.",
  "news.new5": "«Uso del navegador»: el navegador integrado ya era alcanzable por el agente — por accidente, como último candidato del árbol de frames y sin permiso. Ahora es deliberado: las tools preguntan al navegador qué página tiene abierta y piden permiso citando ese sitio antes de tocarlo. Sesión tuya, permiso por sitio.",
  "news.new6": "«Uso del computador»: una tool que mueve el ratón y escribe de verdad en Windows — move, click, type, key, scroll, más leer la posición del cursor y la ventana en primer plano. Sin dependencias nuevas ni addon nativo: un proceso PowerShell persistente con user32, 0,05 ms por acción frente a 310 ms si se lanzara uno por acción.",
  ...
  "news.imp2": "Las protecciones del uso del computador son la función, no un extra, y se aplican en el proceso principal: rechaza las ventanas elevadas —porque Windows descarta la entrada sintética hacia un proceso con más privilegios devolviendo éxito— y su propia ventana; parte de una lista de apps permitidas vacía y vuelve a leer la ventana activa después de que su propio diálogo robe el foco; tiene indicador siempre visible con botón de parada y atajo global; y caduca sola a los 2 minutos de inactividad.",
  "news.imp3": "Sobre el navegador externo, la respuesta honesta: no se puede como esperarías. Chrome 153 y Edge 153 rechazan los dos «--remote-debugging-port» sobre el perfil por defecto, así que sólo se podría automatizar un perfil desechable sin tus sesiones, que es justo lo que le quita el sentido. El uso del computador, además, es sólo Windows en esta v1 y lo dice explícitamente en macOS y Linux en vez de fallar raro.",
  "news.imp4": "Ajustes de transcripción: tamaño del texto (pequeño / medio / grande) y ancho de la transcripción (estrecho / medio / ancho), en Ajustes → Apariencia. El ancho sólo aplica en ventanas de 768 px o más, y lo dice; «medio» reproduce exactamente lo de hoy, así que quien no toque nada no ve ningún cambio.",
  "news.imp5": "El micrófono pide permiso antes de descargar sus 146 MB (1.0.46), con el tamaño calculado a partir de los bytes reales y el progreso en el botón, en vez de hacerlo solo al abrir una sesión.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "Para que «grande» no fuera un ajuste roto se escalaron los 30 tamaños de fuente fijos de los mensajes, que hasta ahora ignoraban cualquier preferencia de tamaño.",
  "news.fix2": "Se recupera un ajuste de tamaño de fuente que existía sin que nadie lo leyera, en vez de dejar dos controles de tamaño conviviendo.",
  "news.fix3": "Una fuga de credenciales real en GitHub (1.0.46): ante un fallo de arranque de git, la línea de comandos completa acababa pintada en el aviso de error, y ahí viaja el token en base64, que es codificación y no cifrado. Se redacta en el único punto por el que pasan todas.",
  ...
  "dl.sub": "Tiancode 1.0.47 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.47",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.47",
  ...
  "page.description": "Tiancode v1.0.47: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.47…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.47 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.47)",
  ...
  "preview.sub": "This is Tiancode v1.0.47: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.47.",
  ...
  "docs.s1p": "Tiancode 1.0.47 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.47 supports Windows 10 and 11.",
  ...
  "news.sub": "Tiancode v1.0.47 is, first of all, a security release: the agent can no longer read or click a page you are not looking at, and both preview tools now ask for permission naming the origin. On top of that come browser use and computer use, each with explicit permission. Includes what landed in 1.0.46.",
  "news.v1": "Version 1.0.47",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Security and Major New Features in v1.0.47",
  "news.new1": "The agent could read and click a page you were not looking at: the only check was “is it http or https?”, with no origin comparison, and the Live view is a full browser with persistent cookies whose native view was hidden without being navigated away. You browsed to a site where you were signed in, started your project, and the model received the URL, the title, 4,000 characters of visible text and every interactive element of that hidden page. The expected origin now rules, and a hidden view is sent to about:blank.",
  "news.new2": "Neither preview tool asked for permission at all: reading and clicking a live page was watched less closely than “glob”. They now ask naming the concrete origin, so a “yes” for this project is not a “yes” for the next page that opens.",
  "news.new3": "Accepting a harmless window screenshot granted full-screen capture forever: the capture tool passed a wildcard pattern, and since the permission system records one rule per pattern, approving a window capture wrote a rule that covered the whole screen too.",
  "news.new4": "A model click on a link could open your real browser at an arbitrary URL: navigation was locked to the origin, but a click on a link was not, and a target “_blank” link ended up in shell.openExternal. It is now denied while an agent action is in flight.",
  "news.new5": "Browser use: the integrated browser was already reachable by the agent — by accident, as the last candidate in the frame tree, with no permission. Now it is deliberate: the tools ask the browser which page it has open and request permission citing that site before touching it. Your session, consent per site.",
  "news.new6": "Computer use: a tool that really moves the mouse and types on Windows — move, click, type, key, scroll, plus reading the cursor position and the foreground window. No new dependency and no native addon: a persistent PowerShell process with user32, 0.05 ms per action against 310 ms if one were launched per action.",
  "news.impTitle": "Improvements in v1.0.47",
  ...
  "news.imp2": "The computer-use safety controls are the feature, not an extra, and they are enforced in the main process: it refuses elevated windows —because Windows discards synthetic input aimed at a more privileged process while returning success— and its own window; it starts from an empty allowlist and re-reads the foreground window after its own dialog steals focus; it has an always-on-top indicator with a stop button and a global shortcut; and it expires on its own after 2 minutes idle.",
  "news.imp3": "On external browsers, the honest answer: it cannot work the way you would expect. Chrome 153 and Edge 153 both refuse “--remote-debugging-port” on the default profile, so only a throwaway profile without your sessions could ever be driven, which is exactly what makes it pointless. Computer use, in turn, is Windows-only in this v1 and says so explicitly on macOS and Linux instead of failing strangely.",
  "news.imp4": "Transcript settings: text size (small / medium / large) and transcript width (narrow / medium / wide), in Settings → Appearance. Width only applies in windows 768 px or wider, and it says so; “medium” reproduces exactly what you have today, so anyone who changes nothing sees no change.",
  "news.imp5": "The microphone asks before downloading its 146 MB (1.0.46), with the size computed from the real bytes and the progress shown on the button, instead of doing it on its own when a session opens.",
  "news.fixTitle": "Fixes",
  "news.fix1": "So that “large” would not be a broken setting, the 30 hard-coded message font sizes were scaled; until now they ignored any size preference at all.",
  "news.fix2": "A font-size setting that existed without anyone reading it is wired up, instead of leaving two size controls side by side.",
  "news.fix3": "A real credential leak in GitHub (1.0.46): on a git start-up failure the full command line ended up painted in the error notice, and the token travels there in base64, which is encoding, not encryption. It is now redacted at the single point they all pass through.",
  ...
  "dl.sub": "Tiancode 1.0.47 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.47? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.47",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.47",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.47",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.47",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.47",
  "footer.ecosystem": "Ecosistema",
