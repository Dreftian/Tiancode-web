...
export const I18N = {
  ...
  "page.description": "Tiancode 1.0.54 para Windows: chat en una fila, 14 especialistas integrados, direcciones visuales para Web App y desconexión persistente de proveedores.",
  "loader.text": "Cargando Tiancode v1.0.54…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.54 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.54)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.54: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.54.",
  ...
  "docs.s1p": "Tiancode 1.0.54 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~345 MB) o la versión portable (~345 MB) desde la página de descarga. La versión 1.0.54 soporta Windows 10 y 11.",
  ...
  "news.v1": "Versión 1.0.54",
  "news.date": "15 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Una fila para trabajar, decisiones de diseño claras",
  "news.new1": "Los controles del chat comparten una sola fila, incluso con Ultracode. En paneles estrechos, captura, micrófono y mejora del prompt quedan accesibles desde Más.",
  "news.new2": "Sub-Agentes muestra los 14 especialistas integrados, con búsqueda, estado y configuración por proyecto o global. El selector principal mantiene Build, Plan y Web App.",
  "news.new3": "Web App permite elegir seis direcciones visuales con una vista de ejemplo o dejar que la IA proponga opciones. La elección se guarda y se envía con el siguiente mensaje.",
  "news.new4": "Respuestas directas es una preferencia opcional para empezar por la acción y presentar instrucciones breves sin omitir errores ni verificaciones.",
  "news.new5": "El navegador permite elegir el integrado, el predeterminado del sistema o Google Chrome para abrir enlaces. Las herramientas de navegación y DOM de la IA siguen usando el navegador integrado.",
  "news.new6": "Uso de la PC puede restaurar ventanas minimizadas de aplicaciones autorizadas al terminar el control. La opción de cookies Hasta salir limpia los datos del navegador al cerrar normalmente.",
  "news.new7": "El especialista de investigación incorpora hipótesis, presupuesto, prueba piloto y decisiones de continuar o detenerse basadas en evidencia, inspiradas en AutoResearch.",
  "news.impTitle": "Mejoras",
  "news.imp1": "La actualización mantiene claves activas, sesiones, configuración, respaldos y autenticación MCP.",
  "news.imp2": "Se revisaron diez repositorios y se documentó qué se adapta, qué requiere una integración adicional y qué no se incluye en el instalador.",
  "news.imp3": "El micrófono mantiene el selector de dispositivo y la opción de mantener pulsado para grabar.",
  "news.imp4": "Mejorar input conserva adjuntos y menciones y permite cancelar o deshacer los cambios del prompt.",
  "news.imp5": "La vista previa muestra la actividad real de las herramientas de la sesión activa y conserva la carpeta del proyecto.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "Un proveedor desconectado, como xKiro, permanece bloqueado aunque una configuración de proyecto o un catálogo desactualizado intente volver a mostrarlo.",
  "news.fix2": "Los avisos de conexión, desconexión y cambio de especialista esperan a que el servidor confirme el guardado; los fallos se muestran y permiten reintentar.",
  "news.fix3": "Los controles estrechos se verifican sin solapamientos y las descripciones de permisos conservan espacio para leerlas.",
  ...
  "dl.sub": "Tiancode 1.0.54 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "dl.news": "¿Qué hay de nuevo en 1.0.54? Lee las novedades.",
  "nav.overview": "Visión General",
  "nav.capabilities": "Capacidades",
  "nav.benchmarks": "Novedades",
  "nav.architecture": "Arquitectura",
  "nav.downloadPill": "Descargar v1.0.54",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Reiniciar animación cósmica de TIANCODE",
  "hero.cosmicBadge": "MODELO DE INTELIGENCIA CÓSMICA · TIANCODE 1.0.54",
  "hero.eyebrowPill": "COMUNICADO DE PRODUCTO",
  "hero.eyebrowMeta": "SEPTIEMBRE 2026 · TIANCODE 1.0.54",
  "hero.title": "Tu proyecto, tus herramientas. Un flujo de trabajo más claro.",
  "hero.lead": "Tiancode 1.0.54 mantiene los controles del chat en una fila y conecta tus decisiones de diseño con el modelo. Elige entre seis direcciones visuales, trabaja con 14 especialistas y conserva tus datos al actualizar.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.54",
  ...
  "benchmarks.eyebrow": "Versión 1.0.54",
  ...
  "footer.status": "Windows · Desktop v1.0.54",
  ...
  "page.description": "Tiancode 1.0.54 for Windows: a single-row composer, 14 integrated specialists, Web App design directions and persistent provider disconnection.",
  "loader.text": "Loading Tiancode v1.0.54…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.54 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.54)",
  ...
  "preview.sub": "This is Tiancode v1.0.54: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.54.",
  ...
  "docs.s1p": "Tiancode 1.0.54 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~345 MB) or the portable build (~345 MB) from the download page. Version 1.0.54 supports Windows 10 and 11.",
  ...
  "news.v1": "Version 1.0.54",
  "news.date": "September 15, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "One row of controls, clear design choices",
  "news.new1": "Chat controls share one row, including Ultracode. In narrow panels, capture, microphone and prompt improvement remain available under More.",
  "news.new2": "Sub-Agents shows 14 integrated specialists with search, status, and project or global settings. The primary selector retains Build, Plan and Web App.",
  "news.new3": "Web App offers six visual directions with sample previews, or lets the AI suggest options. Your choice is saved and sent with the next message.",
  "news.new4": "Direct responses is an optional preference for action-first answers and short instructions without omitting errors or checks.",
  "news.new5": "Links can open in the integrated browser, your system default or Google Chrome. AI browser and DOM tools continue to use the integrated browser.",
  "news.new6": "Computer use can restore minimized windows of authorized applications when control ends. Until exit cookie retention clears browser data on normal shutdown.",
  "news.new7": "The research specialist uses hypotheses, budgets, pilot runs and evidence-based continue or stop decisions inspired by AutoResearch.",
  "news.impTitle": "Improvements in v1.0.54",
  "news.imp1": "The update preserves active keys, sessions, settings, backups and MCP authentication.",
  "news.imp2": "Ten repositories were reviewed, with clear documentation of adapted ideas, additional integration requirements and what is not bundled.",
  "news.imp3": "The microphone retains device selection and hold-to-record.",
  "news.imp4": "Improve input preserves attachments and mentions and lets you cancel or undo prompt changes.",
  "news.imp5": "Live preview shows real tool activity for the active session and preserves the project directory.",
  "news.fixTitle": "Fixes",
  "news.fix1": "A disconnected provider such as xKiro remains blocked when project settings or a stale catalog try to show it again.",
  "news.fix2": "Connection, disconnection and specialist changes wait for the server to confirm the save; failures are shown and can be retried.",
  "news.fix3": "Narrow controls are checked for overlap and permission descriptions retain enough space to read.",
  ...
  "dl.sub": "Tiancode 1.0.54 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.54? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "What's new",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.54",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.54",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.54",
  "hero.title": "Your project, your tools. A clearer workflow.",
  "hero.lead": "Tiancode 1.0.54 keeps chat controls on one row and sends your design choices to the model. Choose from six visual directions, work with 14 specialists and keep your data when updating.",
  "hero.ctaPortable": "Download Portable (.exe)",
  "hero.cmdCopyTitle": "Open release notes and downloads",
  "hero.metaReleaseLabel": "Release",
  "hero.metaReleaseVal": "September 2026 · v1.0.54",
  ...
  "benchmarks.eyebrow": "Version 1.0.54",
