...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.42: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.42…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.42 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.42)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.42: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.42.",
  ...
  "docs.s1p": "Tiancode 1.0.42 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.42 soporta Windows 10 y 11.",
  ...
  "news.sub": "Todo lo que trae Tiancode v1.0.42: zoom real en la vista previa, recarga sin parpadeo mientras el agente construye el frontend y una cabecera del Sandbox que ya no se recorta. Incluye lo llegado en 1.0.41.",
  "news.v1": "Versión 1.0.42",
  "news.date": "11 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades Principales",
  "news.new1": "Zoom real en la vista previa: «+» y «−» recorren escalones del 25 % al 400 % desde la escala en pantalla, el porcentaje fija el 100 % y «Ajustar» vuelve al ajuste automático; si no cabe, la vista se desplaza.",
  "news.new2": "Ver al agente construir paso a paso: los cambios se agrupan en 250 ms, el documento nuevo carga en un segundo iframe oculto y se intercambia al terminar, con el scroll conservado y sin pantalla en blanco.",
  "news.new3": "Cabecera del Sandbox adaptable al ancho del panel: atajos y botones de dispositivo se ocultan cuando no caben y las pestañas «Vista previa / Código» nunca se superponen al selector de carpeta.",
  "news.new4": "Conexiones reales (1.0.41): Telegram, Discord, Slack y Webhooks se configuran y prueban contra el servidor, con tokens en el almacén de credenciales, resúmenes al terminar cada sesión y firma HMAC-SHA256.",
  "news.new5": "Base de datos protegida (1.0.41): copias con instantáneas VACUUM INTO, comprobación de escritura al arrancar y compactación automática.",
  "news.new6": "Skills, Sub-agentes y MCP/Plugins rediseñados (1.0.41): filtros con recuentos, selector de alcance segmentado, pestañas sin recortes y 105 traducciones nuevas.",
  ...
  "news.imp2": "El botón «Fluido» de la cabecera del Sandbox funciona siempre, aunque la preferencia guardada fuera un preset de escritorio, y la cabecera refleja el preset real.",
  "news.imp3": "El cliente de recarga de las vistas estáticas y JSX delega en el Sandbox: una sola recarga por cambio en lugar de tres.",
  "news.imp4": "Ajustes fluidos (1.0.41): se retiran las capas de GPU forzadas, los desenfoques de fondo y las animaciones permanentes que recomponían los 12 paneles en cada cambio de pestaña.",
  "news.imp5": "GitHub e Inteligencia (1.0.41): rama real, «Sincronizar» que espera a todas las peticiones, salida real de git en los fallos y ajustes de memoria que por fin llegan al servidor.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "La vista previa se quedaba al ~54 % con el preset Escritorio FHD y «+» no hacía nada: el zoom manual era solo un techo sobre el ajuste automático y el 100 % real era inalcanzable.",
  "news.fix2": "Entre dos escrituras del agente la vista previa se ponía en blanco y mostraba «Iniciando…»; ahora el documento anterior permanece hasta que el nuevo ha cargado.",
  "news.fix3": "«No se pudo conectar con Servidor local» tras actualizar (1.0.41): la copia de seguridad copiaba la base de datos mientras el servidor escribía y la dejaba en modo solo lectura.",
  ...
  "dl.sub": "Tiancode 1.0.42 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.42",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.42",
  ...
  "page.description": "Tiancode v1.0.42: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.42…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.42 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.42)",
  ...
  "preview.sub": "This is Tiancode v1.0.42: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.42.",
  ...
  "docs.s1p": "Tiancode 1.0.42 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.42 supports Windows 10 and 11.",
  ...
  "news.sub": "Everything Tiancode v1.0.42 brings: real zoom in the live preview, flicker-free reloads while the agent builds the frontend, and a Sandbox header that no longer clips. Includes what landed in 1.0.41.",
  "news.v1": "Version 1.0.42",
  "news.date": "September 11, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.42",
  "news.new1": "Real preview zoom: “+” and “−” step from 25% to 400% starting at the on-screen scale, the percentage sets 100%, and “Fit” returns to auto-fit; when it does not fit, the view scrolls.",
  "news.new2": "Watch the agent build step by step: changes are batched within 250 ms, the new document loads in a hidden second iframe and is swapped in when ready, scroll preserved, no blank screen.",
  "news.new3": "A Sandbox header that adapts to the panel width: shortcuts and device buttons hide when there is no room and the “Preview / Code” tabs never overlap the folder selector.",
  "news.new4": "Real Connections (1.0.41): Telegram, Discord, Slack and Webhooks configured and tested against the server, tokens in the credential store, a summary after every session and HMAC-SHA256 signatures.",
  "news.new5": "Protected database (1.0.41): VACUUM INTO snapshot backups, a write check on startup and automatic compaction.",
  "news.new6": "Redesigned Skills, Sub-agents and MCP/Plugins (1.0.41): filters with counts, a segmented scope selector, tabs that no longer clip and 105 new translations.",
  "news.impTitle": "Improvements in v1.0.42",
  ...
  "news.imp2": "The Sandbox header's “Fluid” button always works, even when the saved preference was a desktop preset, and the header reflects the real preset.",
  "news.imp3": "The reload client of static and JSX previews delegates to the Sandbox: one reload per change instead of three.",
  "news.imp4": "Smooth Settings (1.0.41): forced GPU layers, backdrop blurs and permanent animations that recomposited all 12 panels on every tab switch are gone.",
  "news.imp5": "GitHub and Intelligence (1.0.41): the real branch, a “Sync” that waits for every request, git's real output on failures and memory settings that finally reach the server.",
  "news.fixTitle": "Fixes",
  "news.fix1": "The preview stuck at ~54% with the Desktop FHD preset and “+” did nothing: manual zoom was only a ceiling on auto-fit and a real 100% was unreachable.",
  "news.fix2": "Between two agent writes the preview went blank and showed “Starting…”; the previous document now stays until the new one has loaded.",
  "news.fix3": "“Could not connect to the local server” after updating (1.0.41): the backup copied the database while the server was writing and left it read-only.",
  ...
  "dl.sub": "Tiancode 1.0.42 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.42? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.42",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.42",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.42",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.42",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.42",
  "footer.ecosystem": "Ecosistema",
