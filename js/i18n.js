...
export const I18N = {
  ...
  "page.description": "Tiancode 1.0.53 para Windows: chat adaptable, Build, Plan y Web App, Rápido en todos los modelos y catálogo de especialistas recuperado.",
  "loader.text": "Cargando Tiancode v1.0.53…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.53 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.53)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.53: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.53.",
  ...
  "docs.s1p": "Tiancode 1.0.53 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~345 MB) o la versión portable (~345 MB) desde la página de descarga. La versión 1.0.53 soporta Windows 10 y 11.",
  ...
  "news.v1": "Versión 1.0.53",
  "news.date": "15 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Chat adaptable y especialistas recuperados",
  "news.new1": "El chat reorganiza sus controles según el ancho del panel. Las descripciones del menú de permisos tienen espacio propio y no se superponen.",
  "news.new2": "El selector principal muestra exactamente Build, Plan y Web App; tus definiciones de agentes personalizados se conservan.",
  "news.new3": "Rápido se puede activar en todos los modelos. Reduce preámbulos y trabajo repetido sin cambiar el esfuerzo elegido ni omitir verificaciones.",
  "news.new4": "El panel de subagentes consulta el catálogo correcto en servidores V1 y V2. Los 14 especialistas vuelven a estar disponibles en el escritorio.",
  "news.new5": "Una consulta fallida muestra Reintentar y conserva el último catálogo cargado; ya no se presenta como si no hubiera agentes.",
  "news.new6": "El tema inicial se aplica correctamente al compilar en Windows; la cabecera móvil de la web mantiene sus controles dentro de la pantalla.",
  "news.new7": "Incluye correcciones de OpenCode 1.18.31: restaura modelo, esfuerzo y modo en sesiones ACP, solicita pensamiento resumido en Copilot y muestra los errores de autenticación remota.",
  "news.impTitle": "Mejoras",
  "news.imp1": "Las actualizaciones conservan claves, configuración, sesiones, respaldos y autenticación MCP.",
  "news.imp2": "Especialistas en arquitectura, programación, diseño, rendimiento, datos, QA, IA, móvil, DevOps, investigación, marketing, ingeniería inversa y seguridad autorizada.",
  ...
  "news.fix1": "Se corrige el catálogo vacío causado por consultar una ruta V2 desde el escritorio V1.",
  "news.fix2": "Se eliminan las alturas fijas que hacían superponerse las descripciones de los modos.",
  "news.fix3": "El selector principal ya no mezcla agentes de proyecto con Build, Plan y Web App.",
  ...
  "dl.sub": "Tiancode 1.0.53 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "dl.news": "¿Qué hay de nuevo en 1.0.53? Lee las novedades.",
  "nav.overview": "Visión General",
  "nav.capabilities": "Capacidades",
  "nav.benchmarks": "Novedades",
  "nav.architecture": "Arquitectura",
  "nav.downloadPill": "Descargar v1.0.53",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Reiniciar animación cósmica de TIANCODE",
  "hero.cosmicBadge": "MODELO DE INTELIGENCIA CÓSMICA · TIANCODE 1.0.53",
  "hero.eyebrowPill": "COMUNICADO DE PRODUCTO",
  "hero.eyebrowMeta": "SEPTIEMBRE 2026 · TIANCODE 1.0.53",
  "hero.title": "Tu proyecto, tus herramientas. Un flujo de trabajo más claro.",
  "hero.lead": "Tiancode 1.0.53 adapta el chat al espacio disponible, reúne Build, Plan y Web App y ofrece Rápido en todos los modelos. Trabaja con especialistas, dictado y vista previa, y conserva tus proyectos y configuración al actualizar.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.53",
  ...
  "benchmarks.eyebrow": "Versión 1.0.53",
  ...
  "footer.status": "Windows · Desktop v1.0.53",
  ...
  "page.description": "Tiancode 1.0.53 for Windows: responsive chat, Build, Plan and Web App, Fast for all models and the restored specialist catalog.",
  "loader.text": "Loading Tiancode v1.0.53…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.53 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.53)",
  ...
  "preview.sub": "This is Tiancode v1.0.53: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.53.",
  ...
  "docs.s1p": "Tiancode 1.0.53 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~345 MB) or the portable build (~345 MB) from the download page. Version 1.0.53 supports Windows 10 and 11.",
  ...
  "news.v1": "Version 1.0.53",
  "news.date": "September 15, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Responsive chat and restored specialists",
  "news.new1": "Chat controls wrap to fit the panel. Permission descriptions have their own space without overlapping.",
  "news.new2": "The main selector offers exactly Build, Plan and Web App; your custom agent definitions are preserved.",
  "news.new3": "Fast can be enabled for every model. It reduces preambles and repeated work without changing your selected effort or skipping checks.",
  "news.new4": "The subagent panel uses the correct catalog on V1 and V2 servers. All 14 specialists are available again on desktop.",
  "news.new5": "A failed request offers Retry and retains the last loaded catalog instead of presenting it as empty.",
  "news.new6": "The initial theme loads correctly in Windows builds; the mobile website header keeps its controls within the viewport.",
  "news.new7": "Includes fixes from OpenCode 1.18.31: restores model, effort and mode in ACP sessions, requests summarized thinking in Copilot and displays remote authentication errors.",
  "news.impTitle": "Improvements in v1.0.53",
  "news.imp1": "Updates preserve provider keys, settings, sessions, backups and MCP authentication.",
  "news.imp2": "Specialists cover architecture, coding, design, performance, data, QA, AI, mobile, DevOps, research, marketing, reverse engineering and authorized security.",
  ...
  "news.fixTitle": "Fixes",
  "news.fix1": "Fixed the empty catalog caused by querying a V2 route from the V1 desktop.",
  "news.fix2": "Removed fixed heights that caused permission-mode descriptions to overlap.",
  "news.fix3": "The primary selector no longer mixes project agents with Build, Plan and Web App.",
  ...
  "dl.sub": "Tiancode 1.0.53 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.53? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "What's new",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.53",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.53",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.53",
  "hero.title": "Your project, your tools. A clearer workflow.",
  "hero.lead": "Tiancode 1.0.53 adapts chat to the available space, brings together Build, Plan and Web App, and offers Fast for every model. Work with specialists, dictation and live preview while keeping your projects and settings when updating.",
  "hero.ctaPortable": "Download Portable (.exe)",
  "hero.cmdCopyTitle": "Open release notes and downloads",
  "hero.metaReleaseLabel": "Release",
  "hero.metaReleaseVal": "September 2026 · v1.0.53",
  ...
  "benchmarks.eyebrow": "Version 1.0.53",
