...
export const I18N = {
  ...
  "page.description": "Tiancode 1.0.52 para Windows: modelos locales, especialistas, micrófono configurable, modos de trabajo y vista previa con actividad real.",
  "loader.text": "Cargando Tiancode v1.0.52…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.52 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.52)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.52: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.52.",
  ...
  "docs.s1p": "Tiancode 1.0.52 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.52 soporta Windows 10 y 11.",
  ...
  "news.sub": "Modelos sin entradas fantasma, especialistas depurados, controles del chat y actividad real en el Sandbox. La actualización conserva tus datos y comprueba las descargas.",
  "news.v1": "Versión 1.0.52",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Mejoras de uso diario en v1.0.52",
  "news.new1": "Borrar un GGUF actualiza la configuración y el catálogo de la interfaz sin mantener entradas antiguas.",
  "news.new2": "Especialistas para ingeniería, programación, pruebas, diseño, marketing, datos y seguridad autorizada; puedes crear tus propios agentes.",
  "news.new3": "Vista previa con acciones de la sesión activa, archivos correctos y estados reales de ejecución.",
  "news.new4": "Micrófono con selector visible y opción de mantener pulsado para grabar.",
  "news.new5": "Rápido y Ultracode explican qué aplica el modelo seleccionado, sin prometer una velocidad fija.",
  "news.new6": "La descarga fallida muestra un error; nunca se anuncia como lista para instalar.",
  ...
  "dl.sub": "Tiancode 1.0.52 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "dl.news": "¿Qué hay de nuevo en 1.0.52? Lee las novedades.",
  "nav.overview": "Visión General",
  "nav.capabilities": "Capacidades",
  "nav.benchmarks": "Novedades",
  "nav.architecture": "Arquitectura",
  "nav.downloadPill": "Descargar v1.0.52",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Reiniciar animación cósmica de TIANCODE",
  "hero.cosmicBadge": "MODELO DE INTELIGENCIA CÓSMICA · TIANCODE 1.0.52",
  "hero.eyebrowPill": "COMUNICADO DE PRODUCTO",
  "hero.eyebrowMeta": "SEPTIEMBRE 2026 · TIANCODE 1.0.52",
  "hero.title": "Tu proyecto, tus herramientas. Un flujo de trabajo más claro.",
  "hero.lead": "Tiancode 1.0.52 reúne modelos locales, especialistas, dictado y vista previa en un escritorio para Windows. Revisa cada acción, mejora tus instrucciones y conserva tus proyectos y configuración al actualizar.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.52",
  ...
  "benchmarks.eyebrow": "Versión 1.0.52",
  ...
  "footer.status": "Windows · Desktop v1.0.52",
  ...
  "page.description": "Tiancode 1.0.52 for Windows: local models, specialists, microphone settings, working modes and live preview with real activity.",
  "loader.text": "Loading Tiancode v1.0.52…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.52 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.52)",
  ...
  "preview.sub": "This is Tiancode v1.0.52: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.52.",
  ...
  "docs.s1p": "Tiancode 1.0.52 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.52 supports Windows 10 and 11.",
  ...
  "news.sub": "No phantom model entries, curated specialists, chat controls and real Sandbox activity. Updates preserve your data and verify downloads.",
  "news.v1": "Version 1.0.52",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Everyday improvements in v1.0.52",
  "news.new1": "Deleting a GGUF updates settings and the UI catalog without retaining stale entries.",
  "news.new2": "Specialists for engineering, coding, tests, design, marketing, data and authorized security; you can create your own agents.",
  "news.new3": "Live preview follows the active session, correct files and actual execution states.",
  "news.new4": "Microphone with a visible device selector and hold-to-record option.",
  "news.new5": "Fast and Ultracode explain what applies to the selected model, without promising a fixed speed.",
  "news.new6": "Failed downloads show an error; they are never marked ready to install.",
  "news.impTitle": "Improvements in v1.0.52",
  ...
  "dl.sub": "Tiancode 1.0.52 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.52? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "What's new",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.52",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.52",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.52",
  "hero.title": "Your project, your tools. A clearer workflow.",
  "hero.lead": "Tiancode 1.0.52 brings local models, specialists, dictation and live preview into a Windows desktop. Review each action, improve your instructions and keep your projects and settings when updating.",
  "hero.ctaPortable": "Download Portable (.exe)",
  "hero.cmdCopyTitle": "Open release notes and downloads",
  "hero.metaReleaseLabel": "Release",
  "hero.metaReleaseVal": "September 2026 · v1.0.52",
  ...
  "benchmarks.eyebrow": "Version 1.0.52",
