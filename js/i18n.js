...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.41: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.41…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.41 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.41)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.41: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.41.",
  ...
  "docs.s1p": "Tiancode 1.0.41 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.41 soporta Windows 10 y 11.",
  ...
  "news.sub": "Todo lo que trae Tiancode v1.0.41: Ajustes fluidos, Conexiones reales con Telegram, Discord, Slack y Webhooks, base de datos protegida frente a la copia de seguridad y rediseño de Skills, Sub-agentes y MCP.",
  "news.v1": "Versión 1.0.41",
  "news.date": "11 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades Principales",
  "news.new1": "Conexiones reales: Telegram, Discord, Slack y Webhooks se configuran y prueban contra el servidor, los tokens viven en el almacén de credenciales, cada sesión terminada envía un resumen, los webhooks van firmados con HMAC-SHA256 y el bot de Telegram abre sesiones desde el chat.",
  "news.new2": "Base de datos protegida: la copia de seguridad diaria se hace con instantáneas VACUUM INTO, el servidor comprueba al arrancar que puede escribir y compacta la base automáticamente cuando acumula espacio libre.",
  "news.new3": "Skills rediseñadas: barra de acciones y filtros con recuentos, descripciones a dos líneas y todos los textos traducidos a los 7 idiomas.",
  "news.new4": "Sub-agentes: selector de alcance proyecto/global como control segmentado, tabla más densa y estados traducidos.",
  "news.new5": "MCP y Plugins: pestañas que ya no recortan su etiqueta, explicación compacta de MCP, ruta de los plugins locales una sola vez y catálogo de extensiones con cabecera limpia.",
  "news.new6": "Voces: catálogo completo con las descargadas primero, sin doble descarga, velocidad natural por defecto en Kokoro y Piper y el probador de micrófono libera el micro al cambiar de pestaña.",
  ...
  "news.imp2": "Cambiar de pestaña en Ajustes vuelve a ser fluido: se retiran las capas de GPU forzadas, los desenfoques de fondo y las animaciones permanentes que recomponían los 12 paneles en cada cambio.",
  "news.imp3": "GitHub: la rama actual se lee del control de versiones, «Sincronizar» espera a que terminen todas las peticiones y los fallos de commit, push y pull muestran la salida real de git.",
  "news.imp4": "Inteligencia: los ajustes de memoria y guardrails llegan por fin al servidor por HTTP; el esquema V1 los descartaba en silencio.",
  "news.imp5": "Se retira la pestaña «Ecosistema IA»: 9 de sus 16 tarjetas describían integraciones inexistentes y ningún interruptor tenía efecto.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "«No se pudo conectar con Servidor local» tras actualizar: la copia de seguridad copiaba la base de datos mientras el servidor escribía y la dejaba en modo solo lectura.",
  "news.fix2": "Pestaña «Servidores MCP» con la etiqueta recortada y plugins locales que mostraban la misma ruta dos veces.",
  "news.fix3": "Voces: se corrigen la velocidad 120 %, la clave de Fish Audio incluida en el binario y el botón de borrar desaparecido; el tono solo se muestra cuando el motor lo admite.",
  ...
  "dl.sub": "Tiancode 1.0.41 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.41",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.41",
  ...
  "page.description": "Tiancode v1.0.41: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.41…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.41 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.41)",
  ...
  "preview.sub": "This is Tiancode v1.0.41: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.41.",
  ...
  "docs.s1p": "Tiancode 1.0.41 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.41 supports Windows 10 and 11.",
  ...
  "news.sub": "Everything Tiancode v1.0.41 brings: a smooth Settings panel, real Telegram, Discord, Slack and Webhook connections, a database protected from the backup job, and redesigned Skills, Sub-agents and MCP panels.",
  "news.v1": "Version 1.0.41",
  "news.date": "September 11, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.41",
  "news.new1": "Real Connections: Telegram, Discord, Slack and Webhooks are configured and tested against the server, tokens live in the credential store, every finished session posts a summary, webhooks are HMAC-SHA256 signed, and the Telegram bot opens sessions from chat.",
  "news.new2": "Protected database: the daily backup takes VACUUM INTO snapshots, the server verifies it can write on startup, and it compacts the database automatically when free space piles up.",
  "news.new3": "Redesigned Skills: an action bar and filters with counts, two-line descriptions, and every label translated into the 7 languages.",
  "news.new4": "Sub-agents: a project/global scope selector as a segmented control, a denser table and translated states.",
  "news.new5": "MCP & Plugins: tabs that no longer clip their label, a compact MCP explainer, local plugin paths shown once, and an extension catalog with a clean header.",
  "news.new6": "Voices: the full catalog with downloaded voices first, no double downloads, natural default speed for Kokoro and Piper, and the mic tester releases the microphone when you leave the tab.",
  "news.impTitle": "Improvements in v1.0.41",
  ...
  "news.imp2": "Switching Settings tabs is smooth again: forced GPU layers, backdrop blurs and permanent animations that recomposited all 12 panels on every switch are gone.",
  "news.imp3": "GitHub: the current branch comes from version control, \"Sync\" waits for every request to finish, and commit, push and pull failures show git's real output.",
  "news.imp4": "Intelligence: memory and guardrail settings finally reach the server over HTTP; the V1 schema silently dropped them.",
  "news.imp5": "The \"AI Ecosystem\" tab is gone: 9 of its 16 cards described integrations that did not exist and none of its switches did anything.",
  "news.fixTitle": "Fixes",
  "news.fix1": "\"Could not connect to the local server\" after updating: the backup copied the database while the server was writing and left it read-only.",
  "news.fix2": "The \"MCP servers\" tab clipped its label and local plugins showed the same path twice.",
  "news.fix3": "Voices: the 120% speed, the Fish Audio key bundled in the binary and the missing delete button are fixed; pitch only shows when the engine supports it.",
  ...
  "dl.sub": "Tiancode 1.0.41 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.41? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.41",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.41",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.41",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.41",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.41",
  "footer.ecosystem": "Ecosistema",
