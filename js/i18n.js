...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.48: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.48…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.48 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.48)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.48: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.48.",
  ...
  "docs.s1p": "Tiancode 1.0.48 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.48 soporta Windows 10 y 11.",
  ...
  "news.sub": "Tiancode v1.0.48 es una versión de calidad y acabado: cuando una compilación falla, la vista previa por fin te dice qué pasó —archivo, línea y un enlace al código—; el log del servidor se ve mientras arranca, con los secretos censurados; los avisos de error pasan de 1,24:1 a entre 5,2:1 y 17:1 de contraste; y el asistente de bienvenida es la mitad de alto. Incluye lo llegado en 1.0.47.",
  "news.v1": "Versión 1.0.48",
  "news.date": "12 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades principales",
  "news.new1": "Una compilación fallida no mostraba absolutamente nada: el servidor marcaba el fallo y guardaba hasta 20 errores con archivo y línea, y la interfaz no los leía nunca. Ahora salen en un panel, cada uno como «src/App.tsx:12 — mensaje», y la ubicación es pulsable: te lleva al archivo en la pestaña Código. Con botones para reintentar y para mandárselos al agente.",
  "news.new2": "Y encima los etiquetaba mal: un error de compilación se mostraba como «No se pudo cargar {url} — ¿está el servidor arrancado?», cuando el servidor estaba perfectamente.",
  "news.new3": "«Starting…» era una palabra sola sobre un panel en blanco durante un minuto: el log del servidor ya se estaba descargando y se tiraba a la basura, porque la consola sólo se dibujaba para proyectos de escritorio. Ahora se ve mientras arranca o compila, y con censura de secretos: ese log es el que imprime tu propio proyecto, así que se enmascaran los valores de variables tipo «*_TOKEN», «*_SECRET» y «*_PASSWORD», las cabeceras «Bearer», las URLs con contraseña y los formatos conocidos («sk-…», «ghp_…», JWT). Se enmascara el valor, nunca la línea, y antes de mostrarlo, así que lo que copias al portapapeles ya va limpio.",
  "news.new4": "Los avisos de error estaban en 1,24:1 de contraste sobre el tema claro que la app usa por defecto —el botón «Reparar con IA», el interruptor del inspector, la franja de error de ejecución—, cuando el mínimo accesible es 4,5:1. Se midieron uno a uno los reemplazos en vez de confiar en los tokens: de hecho el par de aviso «warning» tampoco pasa (2,35:1), así que no se usó. Ahora van entre 5,2:1 y 17:1.",
  "news.new5": "El resaltador de la pestaña Código estaba hecho a mano y se equivocaba: un simple «// don't» dejaba las cuatro líneas siguientes pintadas de verde, ignoraba los comentarios «#» de Python y regeneraba 192 KB de HTML en cada pulsación de tecla. Se sustituye por el visor que este repo ya traía, con shiki, virtualización para archivos grandes y modo diff.",
  "news.new6": "El asistente de bienvenida es la mitad de alto: de ~500 px a ~250 px, y de 3 pasos a 2. Importa porque la app lo abre en una ventana de 600 px, donde el primer paso no cabía y salía con barra de desplazamiento.",
  ...
  "news.imp2": "La tarjeta de GitHub se salía por arriba del panel: al crecer con la sección de capacidades, un contenedor centrado que desborda recorta por igual arriba y abajo, así que el logo y el título quedaban fuera de la zona visible y no había forma de subir hasta ellos. Ahora se centra sólo cuando cabe, con margen garantizado a cualquier tamaño de ventana.",
  "news.imp3": "La edición en la pestaña Código pasa a un botón explícito, con un editor sin HTML inyectado y el mismo autoguardado a los 500 ms: el botón «Guardar» era decorativo —el autoguardado limpiaba el estado antes de que a nadie le diera tiempo a pulsarlo— y ahora dice si está guardando. Fuera, además, 125 líneas de insignias de archivo hechas a mano con 8 emojis teñidos con clases de color que a un emoji no le hacen nada.",
  "news.imp4": "Los tres indicadores de estado de la vista previa tienen ya un hueco de ancho fijo, así que el selector de dispositivo y el zoom dejan de deslizarse cada vez que el agente escribe un archivo; y se añade la guarda de «prefers-reduced-motion», que este archivo era el único sin ella.",
  "news.imp5": "Las dos tools de vista previa piden permiso nombrando el origen concreto (1.0.47), así que un «sí» para este proyecto no es un «sí» para la siguiente página que se abra.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "«Renombrar» no renombraba: el backend sólo sabe escribir —no hay mover ni borrar—, así que escribía el contenido en la ruta nueva y dejaba el archivo original. Ahora se llama «Guardar en otra ruta», que es lo que hace.",
  "news.fix2": "El asistente de bienvenida decidía si pintar en claro u oscuro comparando el ajuste «system» con «dark», y eso nunca es cierto: en un equipo con tema oscuro, la primerísima pantalla que ve alguien se pintaba entera en claro sobre un fondo negro, y el fondo que la rodea tenía el mismo error al revés. Los dos usan ya el token del tema.",
  "news.fix3": "El asistente escribía además el modo de color en «data-theme», que guarda el identificador del tema y no el modo, lo que desactivaba las reglas de color de sintaxis hasta el siguiente repintado. Y el punto de estado de la vista previa se ponía verde cuando no había nada corriendo, con la etiqueta «Fit», que es el control de zoom.",
  ...
  "dl.sub": "Tiancode 1.0.48 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.48",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.48",
  ...
  "page.description": "Tiancode v1.0.48: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.48…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.48 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.48)",
  ...
  "preview.sub": "This is Tiancode v1.0.48: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.48.",
  ...
  "docs.s1p": "Tiancode 1.0.48 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.48 supports Windows 10 and 11.",
  ...
  "news.sub": "Tiancode v1.0.48 is a quality-and-polish release: when a build fails, the preview finally tells you what went wrong — file, line, and a link straight to the code; the server log is shown while the server starts, with secrets redacted; error surfaces go from 1.24:1 to between 5.2:1 and 17:1 of contrast; and the welcome wizard is half as tall. Includes what landed in 1.0.47.",
  "news.v1": "Version 1.0.48",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.48",
  "news.new1": "A failed build rendered nothing at all: the server flagged the failure and kept up to 20 errors with file and line, and the UI never read them. They now appear in a panel, each one as “src/App.tsx:12 — message”, and the location is clickable: it takes you to the file in the Code tab. With buttons to retry and to send them to the agent.",
  "news.new2": "And they were mislabelled on top of that: a compile error was shown as “Could not load {url} — is the dev server running?”, when the server was perfectly fine.",
  "news.new3": "“Starting…” was a lone word on a blank panel for a minute: the server log was already being fetched and thrown away, because the console was only drawn for desktop projects. It is now shown while the server starts or compiles, and with secret redaction: that log is whatever your own project prints, so the values of “*_TOKEN”, “*_SECRET” and “*_PASSWORD” variables, “Bearer” headers, credentialed URLs and known shapes (“sk-…”, “ghp_…”, JWT) are masked. The value is masked, never the line, and before it is displayed, so what you copy to the clipboard is already clean.",
  "news.new4": "Error surfaces sat at 1.24:1 contrast on the light theme the app uses by default —the “Fix with AI” button, the inspector toggle, the runtime error strip— against an accessible floor of 4.5:1. The replacements were measured one by one instead of trusting the tokens: in fact the “warning” token pair does not pass either (2.35:1), so it was not used. They now range from 5.2:1 to 17:1.",
  "news.new5": "The Code tab highlighter was hand-rolled and got things wrong: a single “// don't” left the next four lines painted green, it ignored Python “#” comments, and it rebuilt 192 KB of HTML on every keystroke. It is replaced by the viewer this repo already shipped, with shiki, virtualisation for large files, and diff mode.",
  "news.new6": "The welcome wizard is half as tall: from ~500 px to ~250 px, and from 3 steps to 2. It matters because the app opens it in a 600 px window, where step 1 did not fit and scrolled.",
  "news.impTitle": "Improvements in v1.0.48",
  ...
  "news.imp2": "The GitHub card overflowed the top of the panel: as it grew with the capabilities section, a centred container that overflows is clipped at both ends, so the logo and the title fell outside the visible area with no way to scroll up to them. It is now centred only when it fits, with a guaranteed margin at any window size.",
  "news.imp3": "Editing in the Code tab moves to an explicit button, with an editor free of injected HTML and the same 500 ms autosave: the “Save” button was decorative —autosave cleared the state before anyone could press it— and it now says when it is saving. Also gone: 125 lines of hand-rolled file badges with 8 emojis tinted by color classes that do nothing to an emoji.",
  "news.imp4": "The three preview status indicators now have a fixed-width slot, so the device selector and the zoom stop sliding every time the agent writes a file; and the “prefers-reduced-motion” guard is added, this being the one file without it.",
  "news.imp5": "Both preview tools ask for permission naming the concrete origin (1.0.47), so a “yes” for this project is not a “yes” for the next page that opens.",
  "news.fixTitle": "Fixes",
  "news.fix1": "“Rename” did not rename: the backend only knows how to write —there is no move and no delete— so it wrote the content to the new path and left the original file behind. It is now called “Save to another path”, which is what it does.",
  "news.fix2": "The welcome wizard decided light vs dark by comparing the “system” setting against “dark”, which is never true: on a machine with a dark theme, the very first screen anyone sees rendered entirely in light on a black backdrop, and the backdrop around it had the same fault inverted. Both now use the theme token.",
  "news.fix3": "The wizard also wrote the color mode into “data-theme”, which holds the theme identifier and not the mode, disabling the syntax color rules until the next repaint. And the preview status dot turned green when nothing was running, labelled “Fit”, which is the zoom control.",
  ...
  "dl.sub": "Tiancode 1.0.48 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.48? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.48",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.48",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.48",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.48",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.48",
  "footer.ecosystem": "Ecosistema",
