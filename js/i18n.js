...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.50: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.50…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.50 · Agente de IA local-first",
  ...
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.50)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.50: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.50.",
  ...
  "docs.s1p": "Tiancode 1.0.50 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~379 MB) o la versión portable (~379 MB) desde la página de descarga. La versión 1.0.50 soporta Windows 10 y 11.",
  ...
  "news.sub": "Tiancode v1.0.50 arregla el botón de mejorar prompt, que fallaba el 100 % de las veces con cualquier modelo y cualquier configuración — y explica por qué no lo detectó nadie: el contexto que le faltaba es una referencia con valor por defecto, así que su tipo dice «never» y el comprobador de tipos no veía nada. Además, los iconos del compositor dejan de pisarse, «Crear respaldo» respalda de verdad, tres desbordes medidos al píxel y un borrado que escala en vez de rendirse. Incluye lo llegado en 1.0.49.",
  "news.v1": "Versión 1.0.50",
  ...
  "dl.sub": "Tiancode 1.0.50 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.50",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.50",
  ...
  "page.description": "Tiancode v1.0.50: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.50…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.50 · Local-first AI agent",
  ...
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.50)",
  ...
  "preview.sub": "This is Tiancode v1.0.50: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.50.",
  ...
  "docs.s1p": "Tiancode 1.0.50 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~379 MB) or the portable build (~379 MB) from the download page. Version 1.0.50 supports Windows 10 and 11.",
  ...
  "news.sub": "Tiancode v1.0.50 fixes the prompt-improve button, which failed 100% of the time on every model and every configuration — and explains why nobody caught it: the context it was missing is a reference with a default value, so its type says “never” and the type checker saw nothing wrong. Plus the composer icons stop overlapping, “Back up now” actually backs up, three overflows measured to the pixel, and a delete path that escalates instead of giving up. Includes what landed in 1.0.49.",
  "news.v1": "Version 1.0.50",
  "news.date": "September 12, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.50",
  ...
  "news.impTitle": "Improvements in v1.0.50",
  ...
  "dl.sub": "Tiancode 1.0.50 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.50? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.50",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.50",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.50",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.50",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.50",
  "footer.ecosystem": "Ecosistema",
